...
## Corpus Check
- 182 files · ~125,510 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1053 nodes · 2237 edges · 76 communities (62 shown, 14 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 73 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e416a880`
...
Cohesion: 0.06
Nodes (70): Field, SettingsForm(), ToastContext, useToast(), ContactForm(), ERROR_LABELS, FIELDS, EditorForm() (+62 more)
...
Cohesion: 0.08
Nodes (21): Drawer(), COLUMNS, CREAM_78, Footer(), Masthead(), Nav(), RevealArmer(), SiteChrome() (+13 more)
...
Cohesion: 0.11
Nodes (25): ContactPage(), metadata, getConfig, EthicsPage(), metadata, pageMetadata(), PolicyBody(), PolicyList() (+17 more)
...
Cohesion: 0.16
Nodes (11): ArchivesPage(), metadata, ArticleBody(), SECTIONS, getCurrentIssue, getIssues, CurrentIssuePage(), metadata (+3 more)

### Community 17 - "Prototype to Code Mapping"
Cohesion: 0.16
Nodes (18): AUTHORS (six placeholder profiles), DISCIPLINES (five sections), matches (author search predicate), nav(page), NEWS (three announcement articles), note(msg), PAGES / PAGE_TITLES, renderVals (+10 more)
...
Cohesion: 0.25
Nodes (9): STEPS / TIMELINE / TOC_PREVIEW / FACTS / REQS / CHECKLIST, Copy rules, "Our Team" Rename from "Editorial Board", About Page Review-Policy Copy Constraint, Global Constraints, Branch policy, Three Enforced Copy Rules, Spec Copy Rules (two) (+1 more)
...
Cohesion: 0.15
Nodes (15): ANNOUNCEMENTS (three ticker strings), componentDidMount, componentDidUpdate, componentWillUnmount, _reveal, Animations, Continuous Announcement Ticker, Hover states (+7 more)
...
Cohesion: 0.17
Nodes (11): About the Design Files, Fidelity, Files, Handoff: ICRR Journal Website, Overview, State Management, Admin Panel (editor-facing), Policy Pages (/privacy, /terms, /ethics) (+3 more)

### Community 36 - "Site Config Seed"
Cohesion: 0.16
Nodes (17): fromDb(), getAnnouncements, getAuthorBySlug, getDisciplines, getEditorialRoles, getTeam, getTickerLines, useDb() (+9 more)
...
Cohesion: 0.33
Nodes (6): No Border Radius Anywhere, One Shadow in the Whole Design, Three Rule Treatments, Task 17: Design Audit, tests/unit/tokens.test.ts, Two Visual Constraints (no radius, one shadow)
...
Cohesion: 0.67
Nodes (4): Content Layer (src/lib/content/), Cookieless Anon Supabase Client (src/lib/supabase/public.ts), Highwire Press citation_* Tags, Prerendered Public Pages
...
## Knowledge Gaps
- **304 isolated node(s):** `eslintConfig`, `csp`, `SECURITY_HEADERS`, `nextConfig`, `name` (+299 more)
...
- **Why does `ICRR Journal Public Site Implementation Plan` connect `Community 64` to `Community 65`, `Deployment and Security Model`, `Author Profile and TOC`, `Copy and Visual Constraints`?**
