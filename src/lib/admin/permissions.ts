...
export const AREA_LABELS: Record<Area, { label: string; help: string }> = {
  ...
  subscribers: {
    ...
    help: 'The addresses that asked for issue announcements by email.',
  },
  announcement_sends: {
    label: 'Sending announcements',
    help: 'Mailing an announcement to the list. Cannot be undone once sent.',
  },
